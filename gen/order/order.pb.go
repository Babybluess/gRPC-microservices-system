...
const file_proto_order_order_proto_rawDesc = "" +
	"\n" +
	"\x17proto/order/order.proto\x12\x05order\"h\n" +
	...
	"\bquantity\x18\x04 \x01(\x05R\bquantity2\x8e\x01\n" +
	"\fOrderService\x12>\n" +
	"\vCreateOrder\x12\x19.order.CreateOrderRequest\x1a\x14.order.OrderResponse\x12>\n" +
	"\n" +
	"ListOrders\x12\x18.order.ListOrdersRequest\x1a\x14.order.OrderResponse0\x01B\x14Z\x12grpcshop/gen/orderb\x06proto3"
