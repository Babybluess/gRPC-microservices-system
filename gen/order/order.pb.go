...
const file_order_order_proto_rawDesc = "" +
	"\n" +
	"\x11order/order.proto\x12\x05order\x1a\x1cgoogle/api/annotations.proto\"h\n" +
	...
	"\bquantity\x18\x04 \x01(\x05R\bquantity2\xc9\x01\n" +
	"\fOrderService\x12U\n" +
	"\vCreateOrder\x12\x19.order.CreateOrderRequest\x1a\x14.order.OrderResponse\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/v1/orders\x12b\n" +
	"\n" +
	"ListOrders\x12\x18.order.ListOrdersRequest\x1a\x14.order.OrderResponse\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/users/{user_id}/orders0\x01B\x14Z\x12grpcshop/gen/orderb\x06proto3"
...
var file_order_order_proto_depIdxs = []int32{
	...
	1, // 1: order.OrderService.ListOrders:input_type -> order.ListOrdersRequest
	2, // 2: order.OrderService.CreateOrder:output_type -> order.OrderResponse
	2, // 3: order.OrderService.ListOrders:output_type -> order.OrderResponse
